...
/*
try{
	$record=ZCRMRecord::getInstance("Invoices",410405000001164064);
...
/*
 try{
 	...
 	$entityIds=array(410405000001164095,410405000001164067,410405000001113030,410405000001113030,410405000001164065,410405000001164063,410405000001164062);
...
/*
try{
	$record=ZCRMRecord::getInstance("Invoices",410405000001113010);
	...
	$lineItem->addLineTax($taxInstance1);
	$lineItem->setProduct(ZCRMRecord::getInstance("Products",410405000001042005));
...
/*
try{
	$record=ZCRMRecord::getInstance("Leads",41040500000111100);
	$response=$record->uploadPhoto("/Users/sumanth-3058/test11.jpg");
...
/*
 try{
 $record=ZCRMRecord::getInstance("Leads",410405000001178031);

 $responseMap=$record->convert();
 var_dump($responseMap);
 }catch(Exception $e)
 {
 echo $e->getMessage()."\n";
 echo $e->getExceptionCode()."\n";
...
try{
	...
	$record->setFieldValue("Last_Name","Test Lead PHP3");
...
$customViewInstance=ZCRMCustomView::getInstance("Leads",410405000001077005);
...
/*
 * Code to getAllFields
 */
/*
try{
	$moduleIns=ZCRMModule::getInstance("Leads");
	$fields=$moduleIns->getAllFields()->getData();
